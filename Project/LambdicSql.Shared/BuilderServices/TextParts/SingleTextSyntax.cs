...
namespace LambdicSql.BuilderServices.Syntaxes
{
    ...
    /// Single text.
    /// </summary>
    public class SingleTextSyntax : TextPartsBase
    {
        string _text;
        int _indent;
        ...
        /// <returns>Text.</returns>
        public override TextPartsBase ConcatAround(string front, string back) => new SingleTextSyntax(front + _text + back, _indent);
        ...
        /// <param name="front">Front.</param>
        /// <returns>Text.</returns>
        public override TextPartsBase ConcatToFront(string front) => new SingleTextSyntax(front + _text, _indent);
        ...
        /// <returns></returns>
        public override TextPartsBase ConcatToBack(string back) => new SingleTextSyntax(_text + back, _indent);
