...
namespace TestCheck35
{
    ...
    public class TestParameterName
    {
        ...
        {
            public int val1 = 1;
            public SqlExpression<bool> Condition1 => Sql<DB>.Create(DB => val1 == 1);
            public SqlExpression<bool> Condition2 => Sql<DB>.Create(DB => val1 == 2);
            public SqlExpression<bool> GetCondition3()
            {
                int val1 = 0;
                return Sql<DB>.Create(DB => val1 == 3);
            }
        }
