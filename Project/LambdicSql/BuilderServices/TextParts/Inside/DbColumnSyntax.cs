...
{
    class DbColumnSyntax : TextPartsBase
    {
        ColumnInfo _col;
        ...
        internal TextPartsBase ToColumnOnly() => new DbColumnSyntax(_col, true, _front, _back);
        ...
        public override TextPartsBase ConcatAround(string front, string back) => new DbColumnSyntax(_col, _columnOnly, front + _front, _back + back);

        public override TextPartsBase ConcatToFront(string front) => new DbColumnSyntax(_col, _columnOnly, front + _front, _back);

        public override TextPartsBase ConcatToBack(string back) => new DbColumnSyntax(_col, _columnOnly, _front, _back + back);
