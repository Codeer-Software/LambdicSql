...
namespace LambdicSql.Expression.SqlSyntax.Inside
{
    class SqlSyntaxFromAttribute : SqlSyntaxMethodAttribute
    {
        ...
        internal static ExpressionElement ToTableName(IExpressionConverter decoder, System.Linq.Expressions.Expression exp)
        {
        ...
        internal static string GetSqlExpressionBody(System.Linq.Expressions.Expression exp)
        {
