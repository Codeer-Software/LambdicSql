...
namespace LambdicSql.Inside
{
    internal static partial class ExpressionToObject
    {
        ...
        {
            Func<object> _func;
            public void Init(System.Linq.Expressions.Expression exp, ParameterExpression[] param) => _func = System.Linq.Expressions.Expression.Lambda<Func<object>>(exp, param).Compile();
        ...
        class GetterCore<T0> : IGetter
        {
            ...
            Func _func;
            public void Init(System.Linq.Expressions.Expression exp, ParameterExpression[] param) => _func = System.Linq.Expressions.Expression.Lambda<Func>(exp, param).Compile();
