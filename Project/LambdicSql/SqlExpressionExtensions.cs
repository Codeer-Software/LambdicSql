...
namespace LambdicSql
{
    ...
    public static class SetOperationExtensions
    {
        ...
        public static SqlExpression<TResult> Union<TResult>(this ISqlExpressionBase<TResult> lhs, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Union())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);
        public static SqlExpression<TResult> Union<TResult>(this ISqlExpressionBase<TResult> lhs, bool isAll, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Union(isAll))).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);
        public static SqlExpression<TResult> Intersect<TResult>(this ISqlExpressionBase<TResult> lhs, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Intersect())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);
        public static SqlExpression<TResult> Intersect<TResult>(this ISqlExpressionBase<TResult> lhs, bool isAll, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Intersect(isAll))).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);
        public static SqlExpression<TResult> Except<TResult>(this ISqlExpressionBase<TResult> lhs, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Except())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);
        public static SqlExpression<TResult> Except<TResult>(this ISqlExpressionBase<TResult> lhs, bool isAll, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Except(isAll))).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);
        public static SqlExpression<TResult> Minus<TResult>(this ISqlExpressionBase<TResult> lhs, ISqlExpressionBase rhs)
            => lhs.Concat(Sql<Dummy>.Create(db => Keywords.Minus())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs);


        public static SqlQuery<TResult> Union<TResult>(this ISqlQuery<TResult> lhs, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Union())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
        public static SqlQuery<TResult> Union<TResult>(this ISqlQuery<TResult> lhs, bool isAll, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Union(isAll))).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
        public static SqlQuery<TResult> Intersect<TResult>(this ISqlQuery<TResult> lhs, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Intersect())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
        public static SqlQuery<TResult> Intersect<TResult>(this ISqlQuery<TResult> lhs, bool isAll, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Intersect(isAll))).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
        public static SqlQuery<TResult> Except<TResult>(this ISqlQuery<TResult> lhs, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Except())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
        public static SqlQuery<TResult> Except<TResult>(this ISqlQuery<TResult> lhs, bool isAll, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Except(isAll))).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
        public static SqlQuery<TResult> Minus<TResult>(this ISqlQuery<TResult> lhs, ISqlExpressionBase rhs)
            => new SqlQuery<TResult>(lhs.Concat(Sql<Dummy>.Create(db => Keywords.Minus())).Concat(Sql<Dummy>.Create(db => Utils.Text(Environment.NewLine))).Concat(rhs));
    }
}
